...
<div id="content">
    ...
    //     </ul>";
    // }
    // echo '<div class="pagination_div"><ol id="pagination" ><li>Pages: </li>';
    // if ($totalviews >= 1 && $page <= $total) {
    //     for ($x = 1; $x <= $totalviews; $x++) {
    //         echo ($page == $x) ? "<li><a href='/routerconfig/views/suggestion.php/?page=$x'> $x </a></li>" : "<li><a href='/routerconfig/views/suggestion.php/?page=$x'> $x </a></li>";
    //     }
    // } else {
